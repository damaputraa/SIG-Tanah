                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 hidden-xs w100 phone right">
                            <a href="mailto:dama.rahmad21@gmail.com" class="email hidden-xs"><i class="fa icon-envelope-open ph-size" aria-hidden="true"></i> dama.rahmad21@gmail.com</a>
                            <a href="#" class="number hidden-xs"><i class="fa icon-screen-smartphone ph-size" aria-hidden="true"></i> 0821 2477 2867</a>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 logo">
                            <a href="<?php echo base_url() ?>">
                                <h3 id="logotop">SIG - CV. ROSIDA JAYA</h3>
                            <!-- /.logo
